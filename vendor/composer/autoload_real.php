...
class ComposerAutoloaderInit82f45071e91d5675561dbf6ffa155319
{
    ...
    public static function getLoader()
    {
        ...
        $includeFiles = \Composer\Autoload\ComposerStaticInit82f45071e91d5675561dbf6ffa155319::$files;
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire82f45071e91d5675561dbf6ffa155319($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire82f45071e91d5675561dbf6ffa155319($fileIdentifier, $file)
{
