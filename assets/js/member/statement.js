...
$(function () {
	...
	var table = $(".datatables-statement"),
		select2 = $(".select2");
		...
		var dt = table.DataTable({
			...
			columnDefs: [
				...
				},
				{
                    ...
                    var  date = moment(full["payment_date"]).format("MMMM DD, YYYY");
						return date;
					},
				},
				{
					targets: 2,
					render: function (data, type, full, meta) {
						var $official_receipt_number = full["official_receipt_number"];
						return "<span>" + $official_receipt_number + "</span>";
					},
				},
				
                {
					...
					responsivePriority: 4,
					render: function (data, type, full, meta) {
						var $transaction_type = full["transaction_name"];
...

				{
					...
					render: function (data, type, full, meta) {
						return (
							...
							"Member/view/" +
							full["user_id"] +
							'" class="btn btn-sm btn-icon" title="View item details"><i class="bx bx-download"></i></a>' +
