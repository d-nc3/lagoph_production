      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              `<a href=${site_url(Cashiering/view)} ><span class="fw-medium">#' + $invoice_id + '</span></a>`;
            return $row_output;
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              `<a href=${site_url(Cashiering/view)}  data-bs-toggle="tooltip" class="text-body" data-bs-placement="top" title="Preview Invoice"><i class="bx bx-show mx-1"></i></a>` +
              '<div class="dropdown">' +
