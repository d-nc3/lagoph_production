...
$(function () {
	...
	var table = $(".datatables-manager-list"),
		select2 = $(".select2");
	if (select2.length) {
			...
			columnDefs: [
              ...
              `;
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						return `
              <a href="${BASE_URL}Membership/Applicant/view/${full["id"]}" class="btn btn-sm btn-primary" data-id="${full["id"]}" title="View Applicant"><i class="bx bx-show me-1"></i><span class="d-md-inline-block">View</span></a>
            `;
					},
				},
			],
