            ...
            var $row_output = `
              ...
              <div class="d-flex justify-content-start align-items-center user-name">
                ...
                <div class="d-flex flex-column">
                  ...
                  <a href="${BASE_URL}Loans/Loan/index_view/${full["id"]}" class="text-body text-truncate"><span class="fw-medium name">${$name}</span></a>
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return `
              ...
              <a href="${BASE_URL}Loans/Loan/overview/${full["user_id"]}" class="btn btn-sm btn-primary" data-id="${full["user_id"]}" title="View Applicant"><i class="bx bx-show me-1"></i><span class="d-md-inline-block">View</span></a>
