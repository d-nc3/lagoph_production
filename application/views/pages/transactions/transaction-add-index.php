                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            ...
                            <div class="card-datatable table-responsive">
                                <table class="datatables-transaction table border-top">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Id</th>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offCanvassAdd" aria-labelledby="offCanvassAddLabel">
                            ...
                            <div class="offcanvas-header py-4">
                                <h5 id="offCanvassAddLabel" class="offcanvas-title">Add New Transaction type</h5>
                            ...
                            <div class="offcanvas-body border-top">
                                <form class="pt-0" id="addForm" onsubmit="return true">
                                    ...
                                    <!-- Title -->
                                    <div class="mb-3">
                                        <label class="form-label" for="add-unit-name">Transaction Name</label>
                                        <input
                                        type="text"
                                        class="form-control"
                                        id="transactionName"
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offCanvassEdit" aria-labelledby="offCanvassEditLabel">
                            ...
                            <!-- Header -->
                            <div class="offcanvas-header py-4">
                                <h5 id="offCanvassEditLabel" class="offcanvas-title">Edit </h5>
                                <button type="button" class="btn-close bg-label-secondary text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
                            ...
                            <div class="offcanvas-body border-top">
                                <form class="pt-0" id="editForm" onsubmit="return true">
                                    ...
                                    <!-- Title -->
                                    <div class="mb-3">
                                        <label class="form-label" for="edit-unit-name">Transaction Name</label>
                                        <input
                                        type="text"
                                        class="form-control"
                                        id="edit-transaction-name"
                                        placeholder="Edit transaction name"
                                        name="transaction_name"
                                        aria-label="Transaction Name" />
                                    </div>
