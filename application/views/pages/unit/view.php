...
$department_name =   isset($info['department_name'])    &&  $info['department_name']   ?   strtoupper($info['department_name'])   :   '-';
$department_id =   isset($info['department_id'])    &&  $info['department_id']   ?   strtoupper($info['department_id'])   :   0;
$unit_name =   isset($info['unit_name'])    &&  $info['unit_name']   ?   strtoupper($info['unit_name'])   :   '-';
$unit_head =   isset($info['unit_head'])    &&  $info['unit_head']   ?   $info['unit_head']   :   '-';
      ...
      <div class="col-xl-4 col-lg-5 col-md-5">
       ...
       <div class="card mb-4">
        <div class="card-body">
         ...
         <input type="hidden" id="department-id" name="department_id" class="form-control" value="<?= $department_id ?>" readonly />
         ...
         <ul class="list-unstyled mb-4 mt-3">
          ...
          <li class="d-flex align-items-center">
           <span class="fw-medium mx-2">Unit Head:</span>
          </li>
          <li class="d-flex align-items-center mb-3">
           <span class="text-muted mx-2"><?= $unit_head ?></span>
          </li>
          <li class="d-flex align-items-center">
