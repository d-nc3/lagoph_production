          ...
          <div class="d-flex align-items-center">
           <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
            ...
            <li
             ...
             data-popup="tooltip-custom"
             data-bs-placement="top"
             title="Calvin Middleton"
             class="avatar avatar-sm pull-up">
             <img class="rounded-circle" src="assets/img/avatars/17.png" alt="Avatar" />
            </li>
            <li>
          ...
          <div class="d-flex align-items-center">
           <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
            ...
            <li
             ...
             title="Leona Miller"
             class="avatar avatar-sm pull-up">
             <img class="rounded-circle" src="assets/img/avatars/20.png" alt="Avatar" />
            </li>
            <li>
