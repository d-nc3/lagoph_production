...
<div class="layout-wrapper layout-content-navbar">
 <div class="layout-container">
  ...
  <div class="layout-page">
      ...
      <div class="card border rounded">
       <div class="card-body">
        ...
        <div class="d-flex flex-column flex-md-row p-4">
         <div class="w-50">
          ...
          <p class="mb-1 text-muted" style="font-size: 0.9rem;"><?= $user_first_name ?> <?= $user_last_name ?>
          </p>
         </div>
         <div class="w-50">
       ...
       <div class="table-responsive">
        <table class="table table-bordered table-striped">
         ...
         <tbody>
          <?php if ($invoice_type === 'Membership Fee'): ?>
           <tr>
          ...
          <?php elseif ($invoice_type === 'Capital Share'): ?>
           <tr>
            <td class="text-center"><?= $quantity ?></td>
            <td class="text-center">Unit</td>
            <td class="text-center"><?= $particulars ?></td>
       ...
       <div class="card-body">
        <?php if ($status === 'payment-initiated'): ?>
         <div class="d-grid mb-3">
          <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#invoiceActionsModal">Access
        ...
        <?php elseif ($status === 'completed'): ?>
         ...
         <div class="card-body">
          ...
          <div class="my-2">
           <button class="btn btn-primary w-100 mb-3" onclick="copyTransactionDetails()">Copy Transaction
            Details</button>
           <button class="btn btn-label-secondary w-100" onclick="downloadReceipt()">Download Receipt</button>
          </div>
          <div class="my-2">
           <p>This transaction has been added to your <a href="#transaction-history">Transaction History</a>.
           </p>
          </div>
         <?php else: ?>
          <div class="d-grid mb-3">
           <button class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#invoiceActionsOffcanvas"
            aria-controls="invoiceActionsOffcanvas">Proceed to Payment</button>
          </div>
         <?php endif; ?>
        </div>
       </div>
   ...
   <div class="offcanvas offcanvas-end" tabindex="-1" id="invoiceActionsOffcanvas"
    aria-labelledby="invoiceActionsOffcanvasLabel">
    ...
    <div class="offcanvas-body">
     ...
     <form id="payment-form">
      ...
      <div class="mb-3 col-12 mb-0">
       ...
       <input type="file" id="attachments-membership-receipt" name="attachments[membership_receipt]"
        class="form-control" accept=".jpg,.jpeg">
      </div>
      <div class="mb-3 col-12 mb-0">
       <p>Details</p>
       <textarea id="receipt-details" name="receipt_details" class="form-control" rows="4"
   ...
   <!-- Modal -->
   <div class="modal fade" id="invoiceActionsModal" tabindex="-1" aria-labelledby="invoiceActionsModalLabel"
    aria-hidden="true">
       ...
       <div class="card">
        <div class="card-body">
         <?php if ($payment_proof): ?>
          <img src="<?= base_url($payment_proof) ?>" alt="Payment Proof" class="img-fluid rounded"
