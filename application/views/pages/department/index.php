 ...
 <div class="layout-container">
  ...
  <div class="layout-page">
   <?php $this->load->view('layout/navbar'); ?>
    ...
    <h4 class="py-1"><span class="text-muted fw-light">Settings /</span> Department</h4>
      <p>
      A department is assigned specific roles that grant access to predefined menus and features. Based on their assigned role, administrators can control user access, ensuring that each user has the necessary permissions to perform their tasks efficiently.
      </p>
     <div class="card">
      <div class="card-datatable table-responsive">
       <table class="datatables-department table border-top">
        <thead>
         <tr>
          <th></th>
     ...
     <div class="offcanvas offcanvas-end" tabindex="-1" id="offCanvassAdd" aria-labelledby="offCanvassAddLabel">
      ...
      <div class="offcanvas-header py-4">
       <h5 id="offCanvassAddLabel" class="offcanvas-title">Add New Department</h5>
      ...
      <div class="offcanvas-body border-top">
       <form class="pt-0" id="addForm" onsubmit="return true">
        ...
        <!-- Department Heads -->
        <div class="mb-3">
         <label class="form-label" for="add-department-head">Department Head</label>
         <input
          type="text"
          id="add-department-head"
          class="form-control"
          placeholder="Enter Department Head Full Name"
     ...
     <div class="offcanvas offcanvas-end" tabindex="-1" id="offCanvassEdit" aria-labelledby="offCanvassEditLabel">
      ...
      <!-- Header -->
      <div class="offcanvas-header py-4">
       <h5 id="offCanvassEditLabel" class="offcanvas-title">Edit Department</h5>
       <button type="button" class="btn-close bg-label-secondary text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      ...
      <div class="offcanvas-body border-top">
       <form class="pt-0" id="editForm" onsubmit="return true">
        ...
        <!-- Title -->
        <div class="mb-3">
         <label class="form-label" for="edit-department-name">Department Name</label>
         <input
          type="text"
          class="form-control"
        ...
        <!-- Department Heads -->
        <div class="mb-3">
         <label class="form-label" for="edit-department-head">Department Head</label>
         <input
          type="text"
