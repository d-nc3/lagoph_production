...
<?php   
    ...
    $department_head =   isset($info['department_head'])    &&  $info['department_head']   ?   $info['department_head']   :   '-';
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled mb-4 mt-3">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <span class="fw-medium mx-2">Department Head:</span>
                                            </li>
                                            <li class="d-flex align-items-center mb-3">
                                                <span class="text-muted mx-2"><?=$department_head?></span>
                                            </li>
                                            <li class="d-flex align-items-center">
                            ...
                            <div class="col-xl-8 col-lg-7 col-md-7">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-datatable table-responsive mb-3">
                                        <table class="table datatable-unit border-top">
