  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      <li class="nav-item">
        <a class="nav-link <?= ($page_data['system_module'] == 'Overview') ? 'active' : '' ?>" href="<?= site_url('member/view/' . $user_id); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link <?= ($page_data['system_module'] == 'event-logs') ? 'active' : '' ?>" href="<?= site_url('event-logs/' . $user_id) ?>">
          <i class="bx bx-user me-1"></i> Events & Logs
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?= ($page_data['system_module'] == 'statement') ? 'active' : '' ?>" href="<?= site_url('statement/' . $user_id) ?>">
