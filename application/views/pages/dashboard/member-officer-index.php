                    ...
                    <div class="col-lg-8 col-md-6">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h5 class="card-title">Credit Adjustment Requests</h5>
                            </div>
                            <div class="card-datatable table-responsive">
                                <table class="datatables-credit-adjustments table border-top">
                                    <thead>
                                        <tr>
                                            <th>Member Name</th>
                                    ...
                                    <tbody>
                                        <!-- Rows will be populated via server-side script or AJAX -->
                                    </tbody>
                                </table>
                            </div>
                        </div>
