                        ...
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            <div class="d-flex justify-content-between align-items-center mb-3 pe-xl-3 pe-xxl-0">
                              ...
                              <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                4.2 <span class="text-warning"><i class="bx bxs-star me-1"></i></span
                        ...
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                              ...
                              <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                5 <span class="text-warning"><i class="bx bxs-star me-1"></i></span
                        ...
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                              ...
                              <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                3.8 <span class="text-warning"><i class="bx bxs-star me-1"></i></span
                        ...
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                              ...
                              <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                4.7 <span class="text-warning"><i class="bx bxs-star me-1"></i></span
                            ...
                            <p class="d-flex align-items-center text-success">
                              <i class="bx bx-check-double me-2"></i>Completed
                            </p>
                            <div class="progress mb-4" style="height: 8px">
                              <div
                            ...
                            <a class="w-100 btn btn-label-primary" href="app-academy-course-details.html"
                              ><i class="bx bx-sync me-2"></i>Start Over</a
                            >
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="card p-2 h-100 shadow-none border">
                          ...
                          <div class="card-body p-3 pt-2">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                              <span class="badge bg-label-danger">UI/UX</span>
                              <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                3.6 <span class="text-warning"><i class="bx bxs-star me-1"></i></span
