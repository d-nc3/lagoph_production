...
class Payment_account_model extends CI_Model {
    ...
    protected $_table = 'payment_account_map';
    ...
    public function get_by_id($id) {
        // Build the query
        $query = $this->db->select('transaction_account_id')
                          ->where('payment_options_id', $id)
                          ->from($this->_table)
                          ->get();  // Execute the query
        
        // Return a single row as an array
        return $query->row_array();  // Call row_array() on the query result
    }
