...
class Payment_options_model extends CI_Model {
    ...
    protected $_table = 'payment_options';
    ...
    public function get_account_id($data){
        $this->db->select('cash_accounts_id');
    ...
    public function get_option_online(){
        return $this->db->where_in('payment_name', ['E-wallet', 'Bank Transfer'])
                        ->get($this->_table)
                        ->result_array();
    }
